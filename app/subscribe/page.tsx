...
export default function SubscribePage() {
    ...
    const data = [
        { id: "1", feature: "Unlimited Facebook Auto-reply" },
        { id: "2", feature: "Unlimited Keyword Flows" },
        { id: "3", feature: "Auto Order & Lead Collection" },
        { id: "4", feature: "Analytics & Statistics" },
        { id: "5", feature: "7 Days Free Trial" },
        { id: "6", feature: "Priority Support" },
    ];
